...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado) {
        header('Location: alumnos.php?alumnoActualizado=ok');
    } else {
        header('Location: alumnos.php?alumnoActualizado=error');
    }
}
    ...
    <header>
        ...
        <div class="contenedor centrar-flex">
            ...
            <div class="conjunto-botones">
                <a href="alumnos.php" class="btn-subrayado"><i class="icono fa-solid fa-arrow-left"></i> Regresar</a>
            </div>
        </div>
    </header>
