...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado) {
        header('Location: alumnos.php?eliminarAlumno=ok');
    } else {
        header('Location: alumnos.php?eliminarAlumno=error');
    }
}
    ...
    <header>
        ...
        <div class="contenedor centrar-flex">
            ...
            <div class="conjunto-botones">
                <a href="index.php" class="btn-subrayado"><i class="icono fa-solid fa-arrow-left"></i> Regresar</a>
                <a href="registrar-alumno.php" class="btn">Registrar alumno</a>
            </div>
        </div>
    </header>
                ...
                <?php if ($resultado->num_rows >= 1): ?>
                    <?php while ($alumno = mysqli_fetch_assoc($resultado)): ?>
                        <tr>
                            ...
                            <td class="t-center">
                                <!-- Editar registro -->
                                <a href="editar-alumno.php?id=<?php echo $alumno['id']; ?>">
